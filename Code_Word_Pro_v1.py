...
class FontBar():
    def __init__(self, parent,text):
        ...
        self.fram2.grid(row=2,column=0)
        self.toolbar = tk.Frame(self.fram, width=20, height=5)
        self.toolbar.grid(row=1, column=1, columnspan=2, sticky="ew")

        self.shortcutbar = tk.Frame(self.fram2, height=5, width=80)
    ...
    def font_config(self):
        ...
        self.fontsize = ttk.Combobox(
            self.toolbar, width=14, values=self.values, textvariable=self.size
        )
        ...
        self.underline_btn2 = tk.Button(
            ...
            bd=3,
            bg="yellow",
            command=self.changeall_underline,
        )
        self.underline_btn2.grid(row=0, column=5)
        self.align_left_btn = tk.Button(
            self.toolbar, text="LT", bd=3, bg="orange", command=self.align_left
        )
        ...
        self.destory_btn = tk.Button(
            self.toolbar, text="RM FONTBAR", bd=3, bg="light pink", command=self.destory
        )
...
class MenuBar(tk.Menu):
    def __init__(self, parent):
        ...
        self.notebook.add(self.frm2, text="Font Menu")
        ...
        self.update_info()
        self.fontbar = FontBar(self.frm2,self.textwidget)
        ...
        self.textwidget.tag_configure('left_justify', justify='left')
        self.textwidget.tag_configure('right_justify', justify='right')
        self.textwidget.tag_configure('center_justify', justify='center')
        self.textwidget.tag_configure('large_font', font=Font(size=20))
        self.textwidget.tag_configure('bold_italic', font=Font(weight="bold", slant="italic"))
        self.textwidget.tag_configure('italic', font=Font(slant="italic"))
        self.textwidget.tag_configure('bold_', font=Font(weight="bold"))
