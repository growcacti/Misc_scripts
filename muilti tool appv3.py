...
class Filegroup:
    def __init__(self, gtab):
        ...
        self.ext_entry = tk.Entry(self.parent, width=50)
        ...
        self.dest_entry = tk.Entry(self.parent, width=50)
        self.dest_entry.grid(row=2, column=1, padx=10, pady=10)
        self.dest_browse_button = tk.Button(self.parent, text="Browse", command=self.browse_dest)
