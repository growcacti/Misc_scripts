...
from tkinter import Toplevel, Listbox, Entry
...
class AutoCompleteEntry(Entry):
    ...
    def check_key(self, event):
        ...
        # Adjust the listbox placement for grid
...
class TextEditor(tk.Tk):
    def __init__(self):
        ...
        self.columnconfigure(0, weight=1)  # Make the entry widget expandable in width

   
       
        self.rowconfigure(1, weight=1)  # Make the Text widget expandable in both directions
        self.columnconfigure(0, weight=1)  # Ensure the text widget expands horizontally as well
        self.textwidget=ScrolledText(self, bg="white", bd=12)
        self.textwidget.grid(row=10, column=0, padx=10, pady=10, sticky='nsew')
