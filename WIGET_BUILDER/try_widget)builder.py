...
class CodeEditorApp:
    ...
    def generate_code(self):
        ...
        if widget_type == "Entry":
            ...
            widget = tk.Listbox(self.preview_area, width=width, height=height, bg=bg, bd=bd)
        elif widget_type == "Text":
            code = f'tk.Text(root, width={width}, height={height}, bg="{bg}", bd={bd}).pack()'
            widget = tk.Text(self.preview_area, width=width, height=height, bg=bg, bd=bd)
        elif widget_type == "Canvas":
            code = f'tk.Canvas(root, width={width}, height={height}, bg="{bg}", bd={bd}).pack()'
            widget = tk.Canvas(self.preview_area, width=width, height=height, bg=bg, bd=bd)
        else:
